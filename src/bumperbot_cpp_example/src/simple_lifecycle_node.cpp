...
int main(int argc, char * argv[])
{
    ...
    std::shared_ptr<SimpleLifecycleNode> simpel_lifecycle_node = std::make_shared<SimpleLifecycleNode>("simple_lifecycle_node");
    ste.add_node(simpel_lifecycle_node->get_node_base_interface());
    ste.spin();
    rclcpp::shutdown();
    return 0;
}