...
namespace bumperbot_cpp_example
{
...
public:
    ...
    : Node("simple_action_client", options)
    {
        ...
        RCLCPP_INFO(get_logger(), "Action client created");
    }
private:
    ...
    {
        RCLCPP_INFO(get_logger(), "Received feedback: %d", feedback->partial_sequence.back());
        std::stringstream ss;
...
RCLCPP_COMPONENTS_REGISTER_NODE(bumperbot_cpp_example::SimpleActionClient)