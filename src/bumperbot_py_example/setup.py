...
setup(
    ...
    zip_safe=True,
    maintainer='thanh',
    maintainer_email='thanh@todo.todo',
    ...
    entry_points={
        'console_scripts': [
            ...
            'simple_qos_publisher = bumperbot_py_example.simple_qos_publisher:main',
            'simple_qos_subscriber = bumperbot_py_example.simple_qos_subscriber:main',
