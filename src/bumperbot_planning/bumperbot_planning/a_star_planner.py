...
class AStarPlanner(Node):
    ...
    def plan(self, start, goal):
        explore_directions = [(0, 1), (0, -1), (1, 0), (-1, 0)]
        ...
        while not pending_nodes.empty() and rclpy.ok():
            active_node = pending_nodes.get() #get first node
            ...
            self.visited_map_.data[self.pose_to_cell(active_node)] = -106 #orange color in rviz2
